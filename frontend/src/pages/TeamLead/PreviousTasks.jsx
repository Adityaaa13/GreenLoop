            ...
            >
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500">
                        {task.workerId?.name || "Worker"} · Completed {formatDistanceToNow(new Date(task.updatedAt), { addSuffix: true })}
                        {" · "}
                ...
                <div className="px-4 pb-4 pt-0 space-y-3 border-t border-gray-100 bg-gray-50/50 rounded-b-xl">
                    ...
                    {task.workerId && (
                        <div className="text-xs">
                            <p className="text-gray-400 font-medium uppercase tracking-wider mb-0.5">Worker</p>
                            <p className="text-gray-700 font-semibold">{task.workerId.name} ({task.workerId.email})</p>
                        </div>
                    )}
...
const TeamLeadPreviousTasks = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const all = res.data.recentTasks || [];
        ...
        <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">All completed cleanup tasks from your team.</p>
                </div>
                <button
            ...
            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-xs font-semibold text-emerald-600 uppercase tracking-wide">Tasks Completed by Team</p>
                </div>
            </div>
...
export default TeamLeadPreviousTasks;
